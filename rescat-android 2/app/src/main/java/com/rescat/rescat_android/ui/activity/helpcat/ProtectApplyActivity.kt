...
class ProtectApplyActivity : Activity() {
    ...
    private fun setInitLayout() {
        ...
        text_help_apply_header_desc.text = "작성한 개인정보는 임시보호을 위해 글 게시자에게 보여집니다."
        text_adopt_address_info.text = "임시보호글 작성자가 참고할 수 있도록 \n고양이를 보호할 주소를 대략적으로 적어주세요."
    ...
    private fun setDatePicker() {
        ...
        textView.setOnClickListener {
            DatePickerDialog(this@ProtectApplyActivity, dateSetListener,
    ...
    fun show() {
        ...
        //Change the message text View text Size
    ...
    private fun sendData() {
        ...
        val applicationData : PostCareApplication = PostCareApplication(1, name, phone, birth, address, job, houseType!!, companionExperience!!, finalWord)
        ...
        postCareApplyApplication.enqueue(object: Callback<ResponseBody> {
            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                if(response.isSuccessful) {
                    Log.i("test", "success")
                    val intent: Intent = Intent(this@ProtectApplyActivity, ProtectCompleteActivity::class.java)
...
//                    }
                    ...
                    Toast.makeText(this@ProtectApplyActivity, errorMessage, Toast.LENGTH_SHORT).show()
                }
            }
        })
